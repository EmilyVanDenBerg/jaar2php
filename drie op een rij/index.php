...
use Drieopeenrij\Figure;
use Drieopeenrij\Circle;
use Drieopeenrij\Rectangle;
use Drieopeenrij\Square;
use Drieopeenrij\Triangle;

$square1 = new Square(130, 255, 255, 100);
$square2 = new Square(100, 125, 235, 100);
...
$rectangle2 = new Rectangle(50, 100, 130, 120, 235);
...
$triangle2 = new Triangle(75, 75, 130, 120, 255);
$triangle3 = new Triangle(75, 75, 70, 215, 255);
